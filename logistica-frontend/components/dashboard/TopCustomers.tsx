...
import { MOCK_TOP_CUSTOMERS } from '@/lib/mockDashboard';
...
export function TopCustomers({ filters }: TopCustomersProps) {
  const max = Math.max(...MOCK_TOP_CUSTOMERS.map((d) => d.value));
