...
export function CustomerFilters({ params, onChange }: CustomerFiltersProps) {
  ...
  function handleCustomerTypeChange(value: string | null) {
    if (value === 'company' || value === 'individual') {
      onChange({ ...params, customer_type: value, page: 1 });
    } else {
      onChange({ ...params, customer_type: undefined, page: 1 });
    }
  }
  ...
  const customerTypeSelectValue = params.customer_type ?? 'all';
  ...
  return (
    <div className="flex flex-wrap gap-2 items-center">
      ...
      />
      <Select value={customerTypeSelectValue} onValueChange={handleCustomerTypeChange}>
